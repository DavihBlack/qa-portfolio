...
| Test Case ID | Title |
|--------------|-------|
| TC-001       | [Verify that clicking on car models from any section navigates to the correct car model page](../test-cases/tc-01-buggy-cars-navigation.md) | 
| TC-002       | [Verify that clicking on Popular Make section navigates to the correct section](../test-cases/tc-002-popular-make.md) | 
| TC-003       | [Verify that clicking on Overall Rating section navigates to the correct section](../test-cases/tc-003-overall-rating.md) |
