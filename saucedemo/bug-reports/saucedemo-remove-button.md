...
**Screenshot (PLP):**  
![Remove Button PLP](../screenshots/screenshots-saucedemo/saucedemo-remove-button-plp.png)

**Screenshot (PDP):**  
![Remove Button PDP](../screenshots/screenshots-saucedemo/saucedemo-remove-button-pdp.png)
